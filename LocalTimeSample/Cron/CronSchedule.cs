...
namespace Gluu.TaskList.Cron
{
    ...
    public class CronSchedule
    {
        ...
        private static Dictionary<string, string> CronNames = new Dictionary<string, string>();
        ...
        {
            foreach (var replaceStr in CronNames)
            {
                cronExpression = cronExpression.Replace(replaceStr.Key, replaceStr.Value);
            }
